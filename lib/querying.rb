...
def select_series_title_with_most_human_characters
  "Write your SQL query here"
  "SELECT series.title FROM series JOIN characters ON series.author_id = characters.author_id WHERE characterS.species = 'human' GROUP BY species ORDER BY COUNT(species) DESC LIMIT 1" 
end
